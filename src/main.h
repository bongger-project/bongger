...
static const int64 MAX_MONEY = 10000000000 * COIN; // Bongger: maximum of 100B coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 100 * COIN * 1440 / 250; // Bongger: 1440 blocks found a day. Priority cutoff is 100 bongger day / 250 bytes.
    }
