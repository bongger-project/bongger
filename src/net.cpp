...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bongger " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dnsseed01.bongger.com", "dnsseed01.bongger.com"},
    {"dnsseed02.bongger.com", "dnsseed02.bongger.com"},
    {"dnsseed03.bongger.com", "dnsseed03.bongger.com"},
    {"dnsseed04.bongger.com", "dnsseed04.bongger.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bongger is probably already running."), addrBind.ToString().c_str());
        else
