...
{
    return GetBoolArg("-testnet", false) ? 17070 : 7070;
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Bongger server stopping";
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: bongger-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void StartRPCThreads()
{
        ...
        || weakPassword(mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use bonggerd";
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("%s, you must set a secure rpcpassword in the configuration file:\n"
              ...
              "for example: alertnotify=echo %%s | mail -s \"Bongger Alert\" admin@foo.com\n"),
                strWhatAmI.c_str(),
